...
FocusPulse ("we," "our," or "us") is an Android app. FocusPulse is a Pomodoro and focus timer for Android that stores focus sessions and preferences locally on your device. This Privacy Policy explains what information the app collects, how it is used, and the choices you have. By installing or using FocusPulse you agree to the practices described below.

## Information We Collect

### Location Data
- FocusPulse does not collect location data.

### Account Information
- No account is required to use FocusPulse.
- Google Play Billing may process purchase status for premium features.

### Device Information
- Focus sessions, timer settings, break history, notification preferences, and app preferences are stored locally.
- Crash reports may be sent through Firebase Crashlytics if enabled in the app build.

## How We Use Your Information

### Location Sharing
- FocusPulse does not use your location.

### Account Management
- Run focus and break timers.
- Maintain local streaks, statistics, preferences, and premium entitlement status.

### Service Improvement
- Improve focus workflows and app stability.
- Use crash diagnostics to fix technical issues.
- We do not sell, rent, or monetize your focus history.

## Storage and Retention

### Data Storage
- Focus sessions, statistics, and preferences are stored locally using on-device storage such as Room/DataStore.
- Firebase Crashlytics may receive crash diagnostics for stability.

### Data Retention
- Local focus data remains until you delete it, clear app data, or uninstall the app.
- Crash diagnostics are retained by Firebase according to Google/Firebase policies.
...
### Family Groups
- FocusPulse does not use MyFamilyTracker-style family groups unless explicitly described in this policy.
...
### Third Parties
- Firebase Crashlytics may receive crash diagnostics.
- Google Play Billing processes purchase status for premium features.
...
* **POST_NOTIFICATIONS**: Used for timer and break notifications.
* **FOREGROUND_SERVICE and FOREGROUND_SERVICE_MEDIA_PLAYBACK**: Used to keep timer/audio sessions active when needed.
* **WAKE_LOCK and VIBRATE**: Used for reliable timer alerts.
* **ACCESS_NOTIFICATION_POLICY**: Used only if you enable focus-mode notification control.
* **INTERNET and ACCESS_NETWORK_STATE**: Used for Firebase and billing services.
* **com.android.vending.BILLING**: Used for Google Play purchases.

### Optional Permissions

* Notification-policy access and premium purchases are optional.

## Your Rights and Controls

### Location Sharing Control
- No location sharing exists in FocusPulse.

### Account Management
- No app account is required; Google Play purchases are managed through your Google account.

### Data Access
- You can view or delete local focus history and preferences in the app or Android settings.
...
### Permissions
- You can revoke Android permissions in Android Settings -> Apps -> FocusPulse -> Permissions.
...
* **GitHub Repository:** https://github.com/SUDARSHANCHAUDHARI/focuspulse-privacy-policy
* **Email:** sunny.sudarshan@gmail.com
* **Main App Repository:** https://github.com/SUDARSHANCHAUDHARI/FocusPulse
...
- Subject: "Data Deletion Request - FocusPulse"
...
1. Open FocusPulse, if installed
...
FocusPulse is built with privacy in mind. The app is built with:
- Kotlin and Jetpack Compose
- Room/DataStore local storage
- WorkManager/foreground services for reliable timers
